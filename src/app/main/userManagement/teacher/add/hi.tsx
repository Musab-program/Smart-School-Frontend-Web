...
const TeacherForm: React.FC<Props> = ({ teacher }) => {
  ...
  const [professionalInfo, setProfessionalInfo] = useState<ProfessionalInfo>({
    specialtyId: teacher?.SpecialtyId ? String(teacher.SpecialtyId) : "",
    qualification: "", // يمكن ربطها لاحقًا من specialties
  ...
  const handleChange = (
    ...
    section: "basic" | "professional" | "login" | "contact",
    field: string
  ) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    setMessage({ type: "success", text: isEditMode ? "تم تحديث البيانات بنجاح!" : "تم حفظ النموذج بنجاح!" });
  };
    ...
    <div dir="rtl" className="p-8 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6 max-w-6xl mx-auto">
        ...
        <div className="space-x-4">
          ...
          <button
            onClick={() => setMessage({ type: "error", text: "تم إلغاء العملية." })}
      ...
      {message && (
        <div className={`fixed top-4 left-1/2 -translate-x-1/2 px-6 py-3 rounded-lg drop-shadow-lg z-50 text-white ${message.type === "success" ? "bg-green-500" : "bg-red-500"}`}>
          <p>{message.text}</p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        <div className="space-y-8">
          <div className="bg-white p-6 rounded-lg drop-shadow-md">
            <h3 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-4">معلومات أساسية</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium text-gray-700 mb-1">اسم المعلم</label>
                <input
                  type="text"
                  id="fullName"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="space-y-6">
                <div>
                  <span className="block text-sm font-medium text-gray-700 mb-2">الجنس</span>
                  <div className="flex items-center space-x-6">
                    ...
                    <label className="flex items-center text-gray-700">
                      <input
                        ...
                        onChange={(e) => handleChange(e, "basic", "gender")}
                        className="form-radio h-4 w-6 text-lime-700"
                      />
              ...
              >
                <div className="flex flex-col items-center">
                  <svg className="w-12 h-12 text-lime-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v8a4 4 0 01-4 4H8a4 4 0 01-4-4v-8m8-4H8" />
                  </svg>
                  <p className="mt-4 text-sm text-gray-500">قم بإسقاط ملفك هنا</p>
                </div>
                <input type="file" multiple className="absolute inset-0 opacity-0 cursor-pointer" ref={fileInputRef} onChange={handleFileChange} />
                <button type="button" className="mt-4 px-4 py-2 text-sm font-medium text-lime-700 bg-white border border-lime-700 rounded-md hover:bg-lime-50 transition duration-200" onClick={() => fileInputRef.current?.click()}>
                  اختار ملف
                </button>
          ...
          <div className="bg-white p-6 rounded-lg drop-shadow-md">
            <h3 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-4">التفاصيل المهنية</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="specialtyId" className="block text-sm font-medium text-gray-700 mb-1">التخصص</label>
                <select
                  id="specialtyId"
              ...
              <div>
                <label htmlFor="qualification" className="block text-sm font-medium text-gray-700 mb-1">المؤهل</label>
                <select
                  id="qualification"
              ...
              <div>
                <label htmlFor="salary" className="block text-sm font-medium text-gray-700 mb-1">الراتب (بالريال)</label>
                <input
                  type="number"
                  id="salary"
        ...
        <div className="space-y-8">
          <div className="bg-white p-6 rounded-lg drop-shadow-md">
            <h3 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-4">تفاصيل الدخول/الحساب</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="space-y-6">
                  <div>
                    <span className="block text-sm font-medium text-gray-700 mb-2">حالة الحساب</span>
                    <div className="flex items-center space-x-6">
          ...
          <div className="bg-white p-6 rounded-lg drop-shadow-md">
            <h3 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-4">معلومات الاتصال</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
